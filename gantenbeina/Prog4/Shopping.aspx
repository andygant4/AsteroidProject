<%@ Page Title="" Language="C#" MasterPageFile="~/Prog4/Prog4MasterPage.master" AutoEventWireup="true" CodeFile="Shopping.aspx.cs" Inherits="Prog4_Shopping" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Prog4Body" Runat="Server">
    ...
    <asp:CompareValidator ID="CompareValidatorQuan" ControlToValidate="txtQuantity" runat="server" style="z-index:auto;position:relative;width:20%;margin-left:17.5%;" ErrorMessage="Quanity must be a non-negative integer!" Operator="GreaterThan" Type="Integer" ValueToCompare="0"></asp:CompareValidator>
    <br />
    ...
    <asp:Button ID="btnCalculate" runat="server" style="border-style:Solid;z-index: 1; position: relative; width: 15%; margin-left: 43%" Text="Calculate" OnClick="btnCalculate_Click" />
